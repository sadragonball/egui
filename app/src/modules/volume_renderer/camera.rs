...
impl Default for CameraUniform {
    fn default() -> Self {
        Self {
            view_position: [0.; 4],
            proj_view: glam::Mat4::IDENTITY.to_cols_array_2d(),
...
impl Camera {
    ...
    pub fn new(zoom: f32, pitch: f32, yaw: f32, target: glam::Vec3, aspect: f32) -> Self {
        let mut camera = Self {
            zoom,
            pitch,
            yaw,
    ...
    pub fn build_projection_view_matrix(&self) -> glam::Mat4 {
